...
router.post('/', async (req, res) => { 
 const { name, images,categorieID} = req.body; 
 const newSCategorie = new SCategorie({name:name, 
    images:images,categorieID:categorieID }) 
 try { 
...
router.put('/:scategorieId', async (req, res)=> { 
 ...
 const scat1 = { 
    name:name,images:images,categorieID:categorieID, _id:id }; 
